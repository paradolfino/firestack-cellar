...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _add = __webpack_require__(329);

	var _add2 = _interopRequireDefault(_add);

	var _view = __webpack_require__(331);

	var _view2 = _interopRequireDefault(_view);

	var _front = __webpack_require__(332);

	var _front2 = _interopRequireDefault(_front);

	var _thanks = __webpack_require__(333);
	...
	var App = function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    key: "pageHandler",
	    value: function pageHandler(page) {
	      ...
	      switch (this.state.page) {
	        case "front":
	          return React.createElement(
	            "div",
	            { id: this.state.wrapper },
	            React.createElement(_header2.default, { onClick: this.pageHandler }),
	            React.createElement(_front2.default, null),
	        ...
	        case "view":
	          return React.createElement(
	            ...
	            { id: this.state.wrapper },
	            React.createElement(_header2.default, { onClick: this.pageHandler }),
	            React.createElement(_view2.default, { config: this.config }),
	            React.createElement(_footer2.default, null)
	          );
	          break;
	        case "add":
	          return React.createElement(
	            ...
	            { id: this.state.wrapper },
	            React.createElement(_header2.default, { onClick: this.pageHandler }),
	            React.createElement(_add2.default, { onAdd: this.pageHandler }),
	            React.createElement(_footer2.default, null)
	          );
	          break;
	        case "thanks":
	          return React.createElement(
	            ...
	            { id: this.state.wrapper },
	            React.createElement(_header2.default, { onClick: this.pageHandler }),
	            React.createElement(_thanks2.default, null),
	            React.createElement(_footer2.default, null)
	          );
	      }
	    }
	...
	var Header = function (_React$Component) {
	  ...
	  _createClass(Header, [{
	    ...
	    value: function handleClick(e) {
	      var page = e.target.value.toLowerCase();
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        React.createElement(
	          "div",
	          { id: "logo" },
	          React.createElement("img", { src: "https://cdn.worldvectorlogo.com/logos/firebase-1.svg" }),
	          React.createElement(
	            "h4",
	            null,
	            "Firestack Cellar by ",
	            React.createElement(
	              "a",
	              { href: "http://www.viktharienvolander.com", target: "_blank" },
	              "Viktharien Volander"
	            )
	          )
	        ),
	        React.createElement(
	          ...
	          React.createElement(
	            "button",
	            { onClick: this.handleClick, value: "view" },
	            "View"
	          ),
	          React.createElement(
	            "button",
	            { onClick: this.handleClick, value: "add" },
	            "Add"
	          )
	        )
	      );
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'h4',
	            null,
	            'This application was my very first fullstack React project. I\'ve since moved on to better things :)'
	          ),
	          React.createElement(
	            'p',
	            null,
	            ...
	            React.createElement(
	              'a',
	              { href: 'https://github.com/viktharien', target: '_blank' },
	              'my latest projects'
	            ),
	            '. I also link to recent ones on ',
	            React.createElement(
	              'a',
	              { href: 'http://www.viktharienvolander.com', target: '_blank' },
	              'my portfolio'
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _form = __webpack_require__(330);
	...
	function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } //Page for adding whiskey
	...
	var Add = function (_React$Component) {
	  ...
	  function Add(props) {
	    ...
	    _this.addWhiskey = _this.addWhiskey.bind(_this);
	    _this.countRecords = _this.countRecords.bind(_this);
	  ...
	  _createClass(Add, [{
	    ...
	    key: "addWhiskey",
	    value: function addWhiskey(name, year, origin, src) {
	      var _this2 = this;
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            "h2",
	            null,
	            "Add a Whiskey to the Cellar!"
	          ),
	          React.createElement(_form2.default, { onSubmit: this.addWhiskey }),
	          React.createElement(
	            "p",
	            null,
	...
	var Form = function (_React$Component) {
	  ...
	  _createClass(Form, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        "div",
	        { id: "theForm", className: "text-center" },
	        React.createElement(
	          "strong",
	        ...
	        React.createElement("input", { id: "theName", type: "text", placeholder: "Name of Whiskey" }),
	        React.createElement("br", null),
	        React.createElement(
	          "strong",
	          { className: "formElement" },
	        ...
	        React.createElement("br", null),
	        React.createElement("input", { id: "theYear", type: "text", placeholder: "How long has it aged?" }),
	        React.createElement("br", null),
	        React.createElement(
	          "strong",
	          { className: "formElement" },
	        ...
	        React.createElement("br", null),
	        React.createElement("input", { id: "theOrigin", type: "text", placeholder: "Where is it brewed?" }),
	        React.createElement("br", null),
	        React.createElement(
	          "strong",
	          { className: "formElement" },
	          "Image of the whiskey bottle:"
	        ),
	        React.createElement("br", null),
	        React.createElement("input", { id: "theImg", type: "text", placeholder: "External link?" }),
	        React.createElement("br", null),
	        React.createElement(
	          "button",
	          { id: "submit", onClick: this.handleSubmit },
	          "Submit it!"
	        )
	      );
	    }
...
/***/ (function(module, exports) {
	...
	var View = function (_React$Component) {
	  ...
	  function View(props) {
	    ...
	    _this.stage = 0;
	    _this.state = { items: [] };
	    _this.pageFor = _this.pageFor.bind(_this);
	    _this.pageBack = _this.pageBack.bind(_this);
	    _this.viewWhiskey = _this.viewWhiskey.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(View, [{
	    ...
	    key: "viewWhiskey",
	    value: function viewWhiskey(stg) {
	      var _this2 = this;
	      ...
	      setTimeout(function () {
	        switch (stg) {
	          case 0:
	            ...
	            _this2.stage++;
	            _this2.viewWhiskey(_this2.stage);
	            firstC = 1;
	            lastC = 4;
	            break;
	          case 1:
	          ...
	          case 3:
	            ...
	            $("#view").html("");
	            urlRef = rootRef.child("cellar/whiskeys/");
	            urlRef.orderByKey().startAt(firstC.toString()).endAt(lastC.toString()).once("value", function (snapshot) {
	              console.log(snapshot.numChildren());
	              snapshot.forEach(function (child) {
	                var name = child.val().name;
	                var year = child.val().year;
	                var origin = child.val().origin;
	                var src = child.val().src;
	                $("#view").append("<div id='" + name + "' class='card'>" + "<img style=\"background-image: url('" + src + "')\"/><br/><span>Name: " + name + " </span><br/><span>" + year + " from" + " " + origin + "</span></div>");
	              });
	            });
	            break;
	        } //end switch
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            "button",
	            { onClick: this.pageFor },
	            "Next Page"
	          )
	        ),
	        React.createElement(
	          "div",
	          { id: "view", className: "page" },
	...
	var Front = function (_React$Component) {
	  ...
	  _createClass(Front, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        "div",
	        { id: "front", className: "page" },
	        React.createElement(
	          "div",
	          { id: "info", className: "pageElement" },
	          React.createElement(
	            "h2",
	            null,
	            "Welcome to Firestack Cellar"
	          ),
	          React.createElement(
	            "p",
	            null,
	          ...
	          React.createElement(
	            "p",
	            null,
	            "The word 'Firestack' stands for use of React.js, for the front end, and Google Firebase, for the back end, of the app."
	          ),
	          React.createElement(
	            "h4",
	            null,
	          ...
	          React.createElement(
	            "p",
	            null,
	            "This app was to practice React with Firebase. I'm still doing some touch up on the styling."
	          )
	        )
	      );
	    }
...
/***/ (function(module, exports) {
	...
	var Thanks = function (_React$Component) {
	  ...
	  function Thanks(props) {
	    ...
	    return _possibleConstructorReturn(this, (Thanks.__proto__ || Object.getPrototypeOf(Thanks)).call(this, props));
	  }
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            "h1",
	            null,
	            "Thanks for adding! Check it out in the view tab!"
	          )
	        )
	      );
	    }
